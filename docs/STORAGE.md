...
> **Moved to [records/STORAGE.md](records/STORAGE.md) (2026-09-02, the ledger split: LAW stays here, dated RECORDS live under docs/records/ with their section numbers unchanged).** Cited as `STORAGE.md §…` everywhere; open records/STORAGE.md for 8a. S2 OPENED (2026-08-02, user ruling a… through 8. S1 RECORD (2026-08-02; landed same-da… (2 sections).
