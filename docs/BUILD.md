...
> **Moved to [records/BUILD.md](records/BUILD.md) (2026-09-02, the ledger split: LAW stays here, dated RECORDS live under docs/records/ with their section numbers unchanged).** Cited as `BUILD.md §…` everywhere; open records/BUILD.md for 11. Slice records.
