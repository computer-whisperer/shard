...
> **Moved to [records/ISA.md](records/ISA.md) (2026-09-02, the ledger split: LAW stays here, dated RECORDS live under docs/records/ with their section numbers unchanged).** Cited as `ISA.md §…` everywhere; open records/ISA.md for 10. Post-demonstrator review (2026-07-02) [DECIDED].
