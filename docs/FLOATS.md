...
> **Moved to [records/FLOATS.md](records/FLOATS.md) (2026-09-02, the ledger split: LAW stays here, dated RECORDS live under docs/records/ with their section numbers unchanged).** Cited as `FLOATS.md §…` everywhere; open records/FLOATS.md for 10. Rungs and gates.
