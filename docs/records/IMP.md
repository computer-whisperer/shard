# IMP.md — RECORDS (moved out of docs/IMP.md on 2026-09-02)

> **STATUS: RECORD.** Dated rung/slice records split out of [../IMP.md](../IMP.md) so the LAW ledger stays readable in one sitting. Section numbers are exactly as they were in docs/IMP.md; a citation `IMP.md §N` for a section listed here resolves to this file. Nothing here is normative unless the law ledger says so; any "NEXT" pointer is history.
