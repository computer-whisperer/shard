#!/usr/bin/env bash
# lowbuild_x86mem.sh — the x86_64 MEM-fragment artifact build (docs/X86.md
# §15): the mod.build convention end to end for examples/x86mem_src.shard,
...
set -euo pipefail
SRC=examples/x86mem_src.shard
OUT=examples/x86mem_out.shard
BUILD=examples/x86mem_src.build.shard
EVAL=bin/shard_eval
