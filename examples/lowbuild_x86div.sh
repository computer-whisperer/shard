...
# §31, rung B2): the mod.build convention end to end for examples/x86div_src.shard,
...
set -euo pipefail
SRC=examples/x86div_src.shard
OUT=examples/x86div_out.shard
BUILD=examples/x86div_src.build.shard
EVAL=bin/shard_eval
...
echo "ARTIFACT OK: div-fragment binaries + manifest + certs, all five gates green"
