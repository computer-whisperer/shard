...
for LB in examples/lowbuild.sh examples/lowbuild_mem.sh examples/lowbuild_loop.sh examples/lowbuild_call.sh "tools/build/build.sh examples/build_products.shard" examples/lowbuild_x86.sh examples/lowbuild_x86loop.sh examples/lowbuild_x86mem.sh examples/lowbuild_x86call.sh examples/lowbuild_x86chain.sh examples/lowbuild_x86loopcall.sh examples/lowbuild_x86intloop.sh; do
  echo "=== lowering: $LB ==="
  if [ -x bin/shard_eval ]; then
