...
# V3 (FOUNDATION §10.5, phases 1–2): no tier here reaches v3/ — the old tree
# is what these tiers gate; V3's gate is the CI `v3` job (v3/test.sh: the
# kernel tests and phase 2's conformance suites, then T0 on the pinned
# export: v3/t0_full.sh), one job per phase gate.
...
TARGETS=(
  ...
  models/imp/probes/tbh_kit.shard
