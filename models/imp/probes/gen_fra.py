...
BANNERS = {
    ...
    "stmt": (";; --- STEP lemmas, statements (generated by gen_fra.py stmt — REGENERATE, never hand-patch) ---", "stmt"),
}

def emit(which):
    if which == "stmt":   # defined below (A-3); resolved at call time
        return globals()["step_lemmas_stmt"]()
...
if __name__ == "__main__":
    ...
    if arg == "splice":
        ...
        sys.stdout.write(emit({"fe_len": "fe_len", "twin": "twin_laws", "fe_band": "fe_band", "stmt": "stmt"}[arg]))
